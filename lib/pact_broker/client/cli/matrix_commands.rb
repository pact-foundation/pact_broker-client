      ...
      module MatrixCommands
        ...
        def self.included(thor)
          thor.class_eval do
            ...
            method_option :main_branch, required: false, desc: "Use the latest version of the configured main branch of the pacticipant as the version for which you want to check the verification results", default: nil
